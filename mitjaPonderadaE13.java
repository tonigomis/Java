 ...
 */
public class mitjaPonderadaE13 {
    ...
    public static void main(String[] args){
        ...
        menu(s, pesos, notaTotalPractiques, notaTotalExercicis, notaTotalExamens, pesPractiques, pesExamens, pesExercicis, resultat);
    }


    static void calculaMitjana(double[] pesos, double notaTotalPractiques, double notaTotalExamens, double notaTotalExercicis, double pesPractiques, double pesExamens, double pesExercicis, double resultat) {
    ...
    static void menu(Scanner s, double[] pesos, double notaTotalPractiques, double notaTotalExamens, double notaTotalExercicis, double pesPractiques, double pesExamens, double pesExercicis, double resultat) {
                ...
                switch (opcio) {
                    ...
                    case 5:
                        if (comprova[0] && comprova[1] && comprova[2] && comprova[3]) {
                            calculaMitjana(pesos, notaTotalPractiques, notaTotalExamens, notaTotalExercicis, pesPractiques, pesExamens, pesExercicis, resultat);
    ...
    static double notesPractiques(Scanner s) {
        int numNotes, nota;
        double notaTotalPractiques = 0;
    ...
    static double notesExamen(Scanner s) {
        int numNotes, nota;
        double notaTotalExamens = 0;
    ...
    static double notesExercicis(Scanner s) {
        int numNotes, nota;
        double notaTotalExercicis = 0;
